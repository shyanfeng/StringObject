...
void test_stringSubstringInChar_Friday201406_should_return_140(void){
	char *a;
	
	String *str = stringNew(textNew("Friday201406"));
	a = stringSubstringInChar(str, 8, 3);
	
	printf("%s\n", a);
	
	TEST_ASSERT_EQUAL_STRING("140", a);

}

void test_stringSubstringInChar_Tuesday316_over_should_return_empty_space(void){
	char *a;
	
	String *str = stringNew(textNew("Tuesday316"));
	a = stringSubstringInChar(str, 8, 12);
...
void test_stringSubstringInText_Monday403_should_return_text_day40(void){
	
	Text *name = textNew("Monday403");
	String *str = stringNew(name);
	
	Text *stringText = stringSubstringInText(str, 3, 5);
	
	printf("%s\n", stringText->string);
	
	TEST_ASSERT_EQUAL_STRING("day40", stringText->string);
	TEST_ASSERT_EQUAL(0x01, str->reference);
	
}

void test_stringSubstringInText_Monday403_over_should_return_empty_space(void){
	
	Text *name = textNew("Monday403");
	String *str = stringNew(name);
	
	Text *stringText = stringSubstringInText(str, 3, 15);
...
void test_stringToInteger_Wednesday416Thursday_should_return_int_value_416(void){
	int a;
	
	String *str = stringNew(textNew("Wednesday416Thursday"));
	str->start = 9;
	str->length = 3;
	...
	TEST_ASSERT_EQUAL(416, a);

}

void test_stringToInteger_Wednesday416Thursday_should_return_416_for_int_only(void){
	int a;
	
	String *str = stringNew(textNew("AM416PM"));
	str->start = 2;
	str->length = 10;
	a = stringToInteger(str);
